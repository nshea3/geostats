...
lines(z, mmu - 1.96*msd, col="red")
```
The standard 95% CI steady until cutoff $z$ near 2000, when the distribution of curves begins to widen. Blocks over 2000 are a rare event, many simulations will not produce any blocks of this value or higher. Destroyed by averaging. The In fact, the high calorific value blocks occur more in simulations where the high accumulation occurs with the low thickness. 
