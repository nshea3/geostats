...
simu <- simtub(nbtuba = 450, dbin=coal_db,dbout=outdb,model=Tmodel,neigh = neighb)
...
coal_db = db.locate(coal_db,8,"z")

gaus_a = model.create("Gaussian", range=10)
Tmodel=model.create(vartype="Gaussian",range=20,ndim=2)


coal_db <- simtub(dbin = coal_db,dbout=coal_db,model=Tmodel,neigh = neighb,seed=12455)
