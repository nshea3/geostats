...
However, the large variance is consistent with the given model, a multimodal sum of Gaussians distribution.
...
Plotting densities separately for lignite quality classes shows how lignite quality is associated with the accumulation.
...
```
Lignite quality 1 is a distribution centered near 15000 with high variance.
Lignite quality 0 is a distribution centered near 5000 with low variance. 
...
The map of simulated Accumulation shows the spatial behavior of the bimodal distribution, with the high valued  
...
```
Undefined mean and variance? Piecewise Cauchy distribution? 
...
Max panel grade is far lower than max grade at 1x1 scale, and min is higher than max grade at 1x1 scale. E
