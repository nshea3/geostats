...
```{r}
plot(density(coal_df[coal_df$LQ == 1,]$Accumulation), xlim = c(0,25000), main="Density curves for Accumulation distributions",xlab="Accumulation value")
lines(density(coal_df[coal_df$LQ == 2,]$Accumulation), col='blue')
