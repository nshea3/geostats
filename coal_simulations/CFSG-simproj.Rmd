...
plot(db.locate(db.create(jsim,x0=c(0,0),dx=c(1,1),nx=c(200,100)),"jsim","z"), xlab = "X", ylab="Y", title="Accumulation A (Simulated)")
...
plot(cxdb, xlab="X", ylab="Y", title="Calorific Value (Simulated)")
...
plot(panel_q, xlab = "X", ylab = "Y", title = "Calorific Value of Panels (Simulated)")
```
...
```{r}
hist(panel_q@items$Stats.mean, main = paste("Histogram, Calorific Value of Panels"), xlab = "Calorific value of Panels (Simulated)")
```
...
```{r}
plot(z, Tm, type = 'l',main="Tonnage above Cutoff versus Cutoff", xlab="Cutoff", ylab ="Tonnage above Cutoff")
```


```{r}
plot(z, mmu, type = 'l', main="Mean Grade above Cutoff versus Cutoff", xlab="Cutoff", ylab ="Mean Grade above Cutoff")
```
